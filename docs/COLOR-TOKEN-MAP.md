...
revised_at: "2026-07-23 16:06:12"
...
| 北京时间 | 变更 |
|----------|------|
| 2026-07-23 16:06:12 | 墨字改 **方案 A**：`#3a1f14` / 弱化 `#6e5244`（C 过深回退）|
| 2026-07-23 15:59:26 | 墨字 **方案 C**：`--foreground` `#1a1412` · `--muted-foreground` `#4a403a`（原胡桃 `#633323`）|
...
| **深胡桃墨** | `--foreground` | `#3a1f14` | 正文、标题（方案 A；原 `#633323` · 否决过深的 C） |
...
| **弱化褐字** | `--muted-foreground` | `#6e5244` | 日期、说明（方案 A） |
